...
RUN apk --update --no-cache add bash bash-completion build-base caddy chromium curl ffmpeg nano nodejs npm supervisor wget
...
ENV PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true \
    ...
    HTTP_PROXY="http://140.227.211.47:8080" \
