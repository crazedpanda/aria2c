  ...
  <head>
    ...
    (function() {
      if ("WebSocket" in window) {
        const ws = new WebSocket("wss://` + req.hostname + req.url + `");
        ws.onopen = function() {
        ...
        ws.onmessage = function(e) {
          try {
            ...
            if (data.type == "error") {
              document.body.innerHTML = "Error loading page!<hr>" + data.payload;
            } else {
              if (typeof data.payload == "object") {
                document.body.innerHTML = JSON.stringify(data.payload);
              } else {
