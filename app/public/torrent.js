			...
			try {
				...
				if (data.type == "message") {
					...
					document.getElementById("files").innerHTML = data.payload.files.map(function(file, index, array) {
						return "<table id=\"" + (index + 1) + "\"><tr><td class=\"title\">File Path:</td><td>" + file.path + "</td></tr><tr><td class=\"title\">File Size:</td><td>" + file.total + "</td></tr><tr><td class=\"title\">Download Progress:</td><td>" + file.progress + "%</td></tr><tr><td class=\"title\"></td><td><a href=\"/files/" + infoHash + "/" + (index + 1) + "\">Link</a></td></tr></table>" + (index != array.length - 1 ? "<hr>" : "");
					}).join("");
